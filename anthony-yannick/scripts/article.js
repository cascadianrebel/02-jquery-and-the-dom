...
Article.prototype.toHtml = function() {
  ...
  $newArticle.find('a').replaceWith(this.author);
  //TODO: get working authurURL
  $newArticle.attr('href', this.authorUrl);
  $newArticle.find('h1').text(this.title);
  $newArticle.find('.article-body').replaceWith(this.body);
  $newArticle.find('time').replaceWith(this.publishedOn);
...
// }
// articles.forEach(function(dataInsert){
//   $('#articles').append(dataInsert.toHtml());
// });
